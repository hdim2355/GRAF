...
namespace Szeminarium
{
    ...
    {
        public double DistanceToOrigin { get; private set; } = 4;

        public double AngleToZYPlane { get; private set; } = 4;

        public double AngleToZXPlane { get; private set; } = 4;

        const double DistanceScaleFactor = 1.1;

        const double AngleChangeStepSize = Math.PI / 30 * 5;
